...
const Application = sequelize.define(
  'Application',
  {
    ...
    // For fisherman: صياد، صياد تحت السن، مندوب، تاجر، عامل تاجر، شيال
    // For boat: مركب، سيارة، عائمة أفراد
    licenseCategory: {
  ...
  },
  {
    ...
    validate: {
      ...
      validateRequiredFields() {
        ...
        const fishermanCategories = ['صياد', 'صياد تحت السن'];
        const boatCategories = ['مركب أفراد', 'عائمة'];
        const vehicleCategories = ['سيارة'];
        ...
        if (
          ['boat', 'individual_float'].includes(this.applicationType) &&
        ...
        if (this.applicationType === 'fisherman') {
